...
services:
  ...
  cards:
    - icon: "mic"
      name: "Recording"
      description: "Track vocals, guitars, drums, and everything in between in a purpose-built studio space."
    - icon: "sliders"
      name: "Mixing"
      description: "Balance, shape, and polish your tracks into a cohesive sound that hits right."
    - icon: "gauge"
      name: "Mastering"
      description: "Final-stage processing so your music translates on any speaker, anywhere."
    - icon: "music"
      name: "Production"
      description: "Full creative partnership from arrangement to final master — start to finish."
  content: |
    <p>We've got amps and instruments in the studio. Bring your own or use ours — whatever gets the sound right.</p>
  testimonial:
